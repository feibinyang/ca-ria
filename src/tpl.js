...
let controlModulePrefix = {
    ...
    Image: './ca-ria-ui',
    Uploader: './ca-ria-ui',
    SelectorTreeStrategy: './ca-ria-ui',
    TreeRichSelector: './ca-ria-ui',
    TableRichSelector: './ca-ria-ui',
    RichSelector: './ca-ria-ui',
    ToggleButton: './ca-ria-ui',
    AuthPanel: './ca-ria-ui',
    SearchTree: './ca-ria-ui',
    RichBoxGroup: './ca-ria-ui',
    LineChart: './ca-ria-ui',
    PieChart: './ca-ria-ui',
    BarChart: './ca-ria-ui'
};
...
let extensionModulePrefix = {
    ...
    AutoSubmit: 'ca-ria-ui/extension',
    TableTip: 'ca-ria-ui/extension',
    WordCount: 'ca-ria-ui/extension',
    QuickTip: 'ca-ria-ui/extension'
};
